...
To initialize:
  ...
  salesforce = SalesforceBulk::Api.new("YOUR_SALESFORCE_USERNAME", "YOUR_SALESFORCE_PASSWORD+YOUR_SALESFORCE_TOKEN", "LOGIN_HOST")
...
The LOGIN_HOST points to where your user logs in.  This could be a sandbox if you're testing an application.  If you omit the LOGIN_HOST, it defaults to "login.salesforce.com"
